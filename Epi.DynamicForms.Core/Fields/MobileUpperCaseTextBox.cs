...
{
    [Serializable]
    public class MobileUpperCaseTextBox: UpperCaseTextBox
    {
		...
		public override string Response
        {
            ...
            {
                if (_Response != null)
                    return _Response.ToUpper();
                else return null;
            }
            set
            {
                if (value != null)
                    _Response = value.ToUpper();
            }
        }
		...
		public override string RenderHtml()
        {
          ...
          //  txt.Attributes.Add("class", "EpiUpperCaseTextBox");
            //if (_IsDisabled)
            //{
            //    txt.Attributes.Add("disabled", "disabled");
            //}               
            txt.Attributes.Add("style", "" + ErrorStyle + ";" + IsHiddenStyle + ";" + IsHighlightedStyle+ UppercaseTxt);
