...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
 ...
 <asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="infobox">
        <div class="pages">
		<span class="nextprev"><img src="/Content/images/prev_d.png" height="16px" style="vertical-align:text-top;"></span>
		...
		<a href="/page2" class="nextprev" title="Go to Next Page"><img src="/Content/images/next.png" height="16px" style="vertical-align: text-top; text-decoration:none;" border="0"></a>
	  </div>
        ...
        <%=Model.RenderHtml(true) %>
	        ...
	        <div id="nav">
		         <div id="prev" align="left">&nbsp;</div>
 		         <div id="save" align="center"><button class="save" type="submit"><img class="button" src="/Content/images/save.png"> Save & Close</button></div>
 		         <div id="next" align="right"><button class="next" type="submit" onclick="window.location.href='survey2.html'">Continue <img class="button" src="/Content/images/arrow_right.png"></button></div>
	        </div>
	</div>
