...
namespace Epi.Web.BLL
{
    public class User
    {
        ...
        public void GetExistingUser(object p)
        {
        ...
        private bool SendEmail(Email email, Constant.EmailCombinationEnum Combination)
        {
            ...
            switch (Combination)
            {
                ...
                case Constant.EmailCombinationEnum.InsertUser:
                    email.Subject = "An Epi Info Secure Web Survey account has been created for your organization.";
        ...
        public bool SetUserInfo(UserBO UserBO, OrganizationBO OrgBO)
        {
            ...
            //UserBO.PasswordHash = PasswordHasher.HashPassword(salt, "PassWord1");
                ...
                var OrgKey = Epi.Web.Common.Security.Cryptography.Decrypt(OrgBO.OrganizationKey);
                //if (success)
                //{
                //    Email email = new Email();
                //    Body.Append("Welcome to Epi Info™ Secure Web Survey. \nYour account has now been created for organization - " + OrgBO.Organization + ".");
                ...
                //  //  Body.Append("\n\nPlease click the link below to launch the Epi Info™ Secure Web Survey and log in with your email and temporary password. You will then be asked to create a new password. \n" + ConfigurationManager.AppSettings["BaseURL"]);
