...
namespace Epi.Web.Common.Email
{
    ...
    { 
        ...
        public static bool SendMessageToAdmin(string SurveyId, string surveyName,string From, string To, string EmailSubject, string EmailBody)
        {
            try
            {
                ...
                string s = System.Configuration.ConfigurationManager.AppSettings["EMAIL_USE_AUTHENTICATION"];
                ...
                s = System.Configuration.ConfigurationManager.AppSettings["EMAIL_USE_SSL"];
                if (!String.IsNullOrEmpty(s))
                {
                    if (s.ToUpper() == "TRUE")
                    {
                ...
                s = System.Configuration.ConfigurationManager.AppSettings["SMTP_PORT"];
                ...
                message.To.Add(System.Configuration.ConfigurationManager.AppSettings["LOGGING_ADMIN_EMAIL_ADDRESS"].ToString());
                message.Subject = EmailSubject;      // "Link for Survey: " + surveyName; 
                message.From = new System.Net.Mail.MailAddress(System.Configuration.ConfigurationManager.AppSettings["EMAIL_FROM"].ToString());
                message.Body = "";//redirectUrl + " and Pass Code is: " + passCode;
                System.Net.Mail.SmtpClient smtp = new System.Net.Mail.SmtpClient(System.Configuration.ConfigurationManager.AppSettings["SMTP_HOST"].ToString());
                smtp.Port = SMTPPort;

                if (isAuthenticated)
                {
                    smtp.Credentials = new System.Net.NetworkCredential(System.Configuration.ConfigurationManager.AppSettings["EMAIL_FROM"].ToString(), System.Configuration.ConfigurationManager.AppSettings["EMAIL_PASSWORD"].ToString());
                }
